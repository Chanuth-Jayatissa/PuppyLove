...
import { ChevronLeft, Video, CircleCheck as CheckCircle, User } from 'lucide-react-native';
...
export default function SelfieVideoScreen() {
  ...
  const handleStartRecording = () => {
    Alert.alert(
      ...
      'For demo purposes, we\'ll simulate video recording for identity verification.',
      [
        {
          text: 'Cancel',
          style: 'cancel'
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <View style={styles.content}>
            ...
            <TouchableOpacity
              style={[styles.continueButton, !hasRecorded && styles.buttonDisabled]}
